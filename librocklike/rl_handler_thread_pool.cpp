...
HandlerThreadPool::HandlerThreadPool(int threadPoolSize, int maxQueueSize, std::shared_ptr<ServiceGatewayDelegate> svcGwDelBasePtr) :
		queue_(maxQueueSize), notifyFlag_(0), threadPoolSize_(threadPoolSize), svcGateway(svcGwDelBasePtr) {
